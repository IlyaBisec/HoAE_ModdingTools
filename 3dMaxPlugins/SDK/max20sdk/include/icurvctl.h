...
public:
	...
	*/
	...
	new control.\n\n
	This registers a reference target which implements the method
	...
	\par Parameters:
	<b>ReferenceTarget *rmak</b>\n\n
	Points to the reference target which returns the callback object. Note that the
	CurveControl holds this reference target in a SingleWeakRefMaker member, and
	that if no other references are held to this reference target when the CurveControl
	is deleted, the reference target will automatically be deleted as the reference
	is dropped.*/
	virtual void  RegisterResourceMaker(ReferenceTarget *rmak)=0;	// This registers a ReferenceTarget which has to implement GetInterface 
	...
	virtual void  SetTitle(const MCHAR *str)=0;							// Sets the title of the dialog box
...
/*! \sa  Class ReferenceTarget, Class ICurveCtl, Class CurvePoint, <a href="https://msdn.microsoft.com/en-us/library/dd183449(v=vs.85).aspx">COLORREF</a>,
Class BitArray.\n\n
\par Description:
