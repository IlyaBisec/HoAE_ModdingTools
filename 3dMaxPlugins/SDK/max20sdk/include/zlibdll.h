...
#ifdef USE_ISTREAMS
extern gzFile gzopenA (IStream *, const WCHAR *ipath, const char *path, const char *mode);
extern gzFile gzopenW (IStream *, const WCHAR *ipath, const WCHAR *path, const WCHAR *mode);
#else
extern gzFile gzopenA (const char *path, const char *mode);
extern gzFile gzopenW (const WCHAR *path, const WCHAR *mode);
#endif

#if defined(UNICODE)
#define gzopen gzopenW
#else
#define gzopen gzopenA
#endif
