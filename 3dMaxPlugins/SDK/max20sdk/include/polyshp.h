...
//! \name Opened/Closed/Self Intersects/Clockwise/Surrounds Point 
//! @{	
...
//! \name Bounding Box/InvalidateGeomCache
//! @{	
...
//! \name Render/Select/Snap/Transform
//! @{		
	...
	* \param useStartSegments = TRUE if this is set the start/endsegments will be used 
...
//! \name Interpolated Points/Tangent Vectors
//! @{	
...
public:
	...
	* specified PolyShape. */
	...
	/** For Internal use only. Initializes member variables. 
...
//! \name Bounding Box/InvalidateGeomCache/InvalidateCapCache
//! @{	
...
//! @}
	...
	* \param pLines Array of lines to append. 
