...
- 3ds Max R14 not binary compatible with previous releases
- 3ds Max R15 not binary compatible with previous releases
- 3ds Max R16 is binary compatible with 3ds Max R15
- 3ds Max R17 not binary compatible with previous releases
...
//! 3ds Max R15 pre-Alpha mbcs SDK - incompatible with 3ds Max 2012 and 3ds Max 2013 unicode builds
#define MAX_API_NUM_R150_ALPHA_MBCS		39	 
//! 3ds Max R15 pre-Alpha unicode SDK - incompatible with 3ds Max 2012 and 3ds Max 2013 mbcs builds
#define MAX_API_NUM_R150_ALPHA_UNICODE		40	 
//! 3ds Max R15 SDK - incompatible with 3ds Max 2012, remains the version number set for the pre-Alpha unicode SDK
//! This was decided because it was not incremented at SDK freeze, despite breaking changes.
#define MAX_API_NUM_R150 MAX_API_NUM_R150_ALPHA_UNICODE
//! 3ds Max R16 Alpha 1 SDK. SDK is compatible with 3ds Max 2013 builds except for new APIs.
#define MAX_API_NUM_R160_ALPHA1		41	 
//! 3ds Max R16 SDK. SDK is compatible with 3ds Max 2013 builds except for new APIs.
#define MAX_API_NUM_R160			42	 
//! 3ds Max R17 (2015) Preview SDK; incompatible with 3ds Max R16 (2014).
#define MAX_API_NUM_R170_PREVIEW	43	 
//! 3ds Max R17 (2015) SDK; incompatible with 3ds Max R16 (2014).
#define MAX_API_NUM_R170			44	 
//! 3ds Max R18 (2016) Preview SDK; compatible with 3ds Max R17 (2015).
#define MAX_API_NUM_R180_PREVIEW	45	 
//! 3ds Max R18 (2016) SDK; compatible with 3ds Max R17 (2015).
#define MAX_API_NUM_R180	46	 
//! 3ds Max R19 (2017) Preview SDK; incompatible with 3ds Max R18 (2016).
#define MAX_API_NUM_R190_PREVIEW	47
//! 3ds Max R19 (2017) SDK; incompatible with 3ds Max R18 (2016).
#define MAX_API_NUM_R190	48
//! 3ds Max R20 (2018) Preview SDK; incompatible with 3ds Max R19 (2017).
#define MAX_API_NUM_R200_PREVIEW	49
//! 3ds Max R20 (2018) SDK; incompatible with 3ds Max R19 (2017).
#define MAX_API_NUM_R200	50
//! 3ds Max R21 (2019) Preview SDK; incompatible with 3ds Max R20 (2018).
...
\param maxRelease the version of max from the \ref VersionMacros Version Macros to check against
\param maxExt the extension version to check against
*/
CoreExport bool IsMaxVersionNewerOrSame(unsigned int maxRelease, unsigned int maxExt);

/** 
Returns the 3ds Max extension number. It returns 0 if there's no extension installed.
*/
CoreExport unsigned int GetMaxExtensionVersion();

//! \brief Allows to identify the product based on an identifier.
/*! \deprecated As of 3ds Max 2016, there is only one product.
*/
enum APPLICATION_ID {kAPP_MAX};

/** Returns the ApplicationID. 
    Note: as of 3ds Max 2016, only a value of kAPP_MAX will be returned. 
    Note: as of 3ds Max 2017, this method no longer has an implementation. 
*/
MAX_DEPRECATED APPLICATION_ID GetAppID();
...
/// \cond OBSOLETE
#define USERDATATYPE_CLASS_ID		0x000B60    //!< User Datatype class ID. This is obsolete.
/// \endcond
...
#define DATACHANNELENGINE_SUPER_CLASS_ID 0x11992ac //!< IDataChannelEngine super-class ID. 
#define MAXFLUID_SOLVER_SUPERCLASS_ID	0x0011c0	//!< Fluid solver (i.e. liquid, smoke, fire...)
//@}

//! \name Controller super-class IDs
//! These super-class IDs identify the different kinds of controller (Control) plug-ins.
//@{
#define	CTRL_SHORT_CLASS_ID 	   	0x9001  //!< Short controller super-class ID. This is obsolete.
#define	CTRL_INTEGER_CLASS_ID		0x9002  //!< Integer controller super-class ID. This is obsolete.
#define	CTRL_FLOAT_CLASS_ID			0x9003  //!< Float controller super-class ID.
#define	CTRL_POINT2_CLASS_ID	   	0x9004  //!< Point2 controller super-class ID. This is obsolete.
#define	CTRL_POINT3_CLASS_ID	   	0x9005  //!< Point3 controller super-class ID.

//! \deprecated Deprecated as of 3ds Max 2013. Use CTRL_POSITION_CLASS_ID instead. 
#pragma deprecated("CTRL_POS_CLASS_ID")
//! \deprecated Deprecated as of 3ds Max 2013. Use CTRL_ROTATION_CLASS_ID instead. 
#pragma deprecated("CTRL_QUAT_CLASS_ID")

#define	CTRL_MATRIX3_CLASS_ID		0x9008  //!< Matrix3 controller super-class ID.
#define	CTRL_COLOR_CLASS_ID     	0x9009	//!< Color controller super-class ID. This is obsolete.
#define	CTRL_COLOR24_CLASS_ID   	0x900A  //!< Color24 controller super-class ID. This is obsolete.
...
#define CTRL_USERTYPE_CLASS_ID		0x900F  //!< User defined type for a controller super-class ID. This is obsolete.
...
#define TEMP_OBJECT_CLASSID				0xbeef406a		// represents a temporary object that will be deleted after load
//@}
...
#define NEWBOOL_CLASS_ID		Class_ID(0x51db4f2f,0x1c596b1a) //!< Boolean object Class ID
#define BOOLEAN2OBJ_CLASS_ID	Class_ID(0x7bc209af, 0x01bbac5f) //!< Boolean2 object Class ID
#define SHAPEBOOLEANOBJ_CLASS_ID Class_ID(0x6b963d5f, 0x6e243528) //!< Shape Boolean Class ID
...
#define XREFCTRL_CLASS_ID Class_ID(0x32fb4637, 0x65fd482b) //!< matrix3 type XRef control class ID
#define FLOAT_XREFCTRL_CLASS_ID Class_ID(0x0626200e, 0x049070cc) //!< float type XRef control class ID
#define POINT3_XREFCTRL_CLASS_ID Class_ID(0x0603ee00, 0x0105530f) //!< point3 type XRef control class ID
#define POINT4_XREFCTRL_CLASS_ID Class_ID(0x46320d2a, 0xb1c3177e) //!< point4 type XRef control class ID
//@}
...
#define MR_PHYSSUN_CLASS_ID Class_ID(0x71503bbb, 0x25e21124)    //!< Class id for the Mental Ray Physical Sun Light object
#define MRPHYSSKY_LIGHT_OBJECT_CLASSID	Class_ID(0x26ee3350, 0x799b5b56)    //!< Class id for the Mental Ray Physical Sky object
//@}
...
#define DMTL2_CLASS_ID  		0x00000003	//!< Was used when migrating from StdMtl to StdMtl2.
...
#define DXMATERIAL_CLASS_ID		Class_ID(0xed995e4, 0x6133daf2) //!< DirectX material class ID
#define ARCHITECTURALMATERIAL_CLASS_ID	Class_ID(0x13d11bbe, 0x691e3037)    //!< (Legacy) Architectural Material class ID
#define SRR_MATERIAL_CLASSID Class_ID(0x2914493d, 0x6cff42f7)   //!< Advanced Lighting Override material
#define SHELLAC_CLASS_ID        Class_ID(0x46ee536a, 0)
#define SKELETON_CLASS_ID       Class_ID(0x1a8169a, 0x4d3960a5)      //!< Ink&Paint material
#define RAYMTL_CLASSID          Class_ID(0x27190ff4, 0x329b106e) //!< Raytrace material
//@}
...
#define MULTITILE_CLASS_ID 		0x00002E0   //!< MultiTile texture
...
#define PARTAGE_CLASSID	    Class_ID(0x8d618ea4,0x49bbe8cf)     //!< Particle Age texture map
#define PARTBLUR_CLASSID	Class_ID(0x8a746be5,0x81163ef6)     //!< Particle Blur texture map
#define WOOD_CLASS_ID		Class_ID ( 0x0000214, 0 )	
#define MRSKYENVSHADER_CLASS_ID	Class_ID(0x628e269e, 0x72386abf) //!< Class id for the Mental Ray Physical Sky Environment Map
#define PHYSICAL_SUN_SKY_ENV_CLASS_ID Class_ID(0x223349b4, 0x562a7d8b) //!< Class id for the Physical Sky environment class ID
...
#define VIZ_BRICKS_CLASSID  Class_ID( 0x64035fb9, 0x69664cdc )  //!< Tiles Map (old name was Bricks)
//@}
...
#define RapidRTRenderer_CLASS_ID    Class_ID(0xb1a427cd, 0xa045556f)    //!< Class ID for ART renderer
#define RayEngineGlobalData_ClassID Class_ID(0x4fa95e9b, 0x09a26e66)    //!< Class ID for "Raytrace" tab in the render dialog
#define AutodeskCloudRendererClassID Class_ID(0x336b421a, 0x574b21ea)    //!< Class ID for the Autodesk A360 Cloud Renderer
//@}
...
#define M3MatClassID                Class_ID(0x4b9937e0, 0x3a1c3da4)       //!< maxsdk\samples\modifiers\morpher\wM3.h
//@}
...
class ClassDesc: public MaxHeapOperators {
	...
	public:
		...
		~{ Loading and Saving Plug-in Data }~ for more information.\n\n
		...
		themselves. See
		~{ Object Creation Methods }~ for more details. */
		...
		modifiers. See \ref SuperClassIDs "Super Class IDs".
		...
		/** \name Class Parameter Related Methods
		* The following three methods deal with default settings for plug-in classes.
		* Most plug-ins do not need to be concerned with these methods.
		* In the 3ds Max user interface, there are options for Controller Defaults in
		* the Animation tab of the Preference Settings dialog. There are buttons for
		* 'Set Defaults' and 'Restore to Factory Settings'. When the user presses the
		* 'Set Defaults' button the user is presented with a list of plug-ins that have
		* responded TRUE to the HasClassParams() method. These plug-ins have default
		* parameters that the user can edit. These are the defaults used when a new
		* instance of the plug-in class is created. When the user picks an item from
		* the list, its EditClassParams() method is called to allow the plug-in to put
		* up a modal dialog to let the user edit the default parameters.
		* If the user presses the 'Reset to Factory Settings' button, the
		* ResetClassParams() method is called. The plug-in can then be reset
		* to use any default settings that it has. 
		*/
		///@{
		...
		*/
		...
		\note Ownership of the ActionTable is transferred to 3ds Max when this function is 
		called, and it should not be deleted by the plug-in.
		...
		*/
		...
		For older plugins that did not previously implement InternalName but now do, 
		MAXScript still needs to expose the plugin using the ClassName. But new plugins
		can be exposed using only the InternalName. 
		*/
		virtual bool			UseOnlyInternalNameForMAXScriptExposure() { return false; }
		...
		\note if the resource ID value is 0, a blank string is returned. If the resource ID value cannot
		be found, the string ">>> @!&*# <<<" is returned.
		*/
		CoreExport virtual const MCHAR* GetRsrcString(INT_PTR id);
		...
		virtual bool			SetUserDlgProc(ParamBlockDesc2* pbd, ParamMap2UserDlgProc* proc = NULL) { return false; }
		...
		//! \name Schematic View Related Method
		//! @{
		/** Allows a plug-in to provide a custom image for
		display in Schematic View.
		\param bkColor The background color. See <a href="https://msdn.microsoft.com/en-us/library/dd183449(v=vs.85).aspx">COLORREF-DWORD format</a>.
		...
		CoreExport virtual FPInterface*	GetInterface(const MCHAR* name);
		...
		//! \name Generic Expansion Function
		//! @{
...
/// \name Class Instance Creation
//@{
/** Creates an instance of a class specified by superclass ID and class ID.  This can be useful when
    there is no convenience method for creating the desired class.
	
	Many classes have named IDs defined in plugapi.h.
	You can also obtain the numeric class ID of a class using the MaxScript ShowClass() function, or from an
	object in a scene using $obj.ClassID().  Here's an example of output for a selected skylight object:
	
	\code
	$.classid  --> #(2079724664, 1378764549)
	$.superclassid --> 48
	showclass "skylight" --> Skylight : light {7bf61478,522e4705}
	\endcode
	  
   \par Example:
   This example creates a skylight instance.
   \code
