...
public:
    ...
    the mouse is over them, so this should return `kFullRedrawNeeded`.
	\par Default Implementation:
    <code>{return kNoRedrawNeeded; }</code> 
    \param t - The time to display the object.
    \param pVpt - An interface that may be used to call methods associated with the
    viewports.
    \param &m - The location of the tooltip.
    \param *pHitData - A pointer to the hitdata containing information on which manipulator was
    hit.
    ...
    */
    ...
    over them, so this should return `kFullRedrawNeeded`.
	\par Default Implementation:
    <code>{return kNoRedrawNeeded; }</code> 
    \param t - The time to display the object.
    \param *pVpt - An interface that may be used to call methods associated with the
...
/*! \sa  Class BaseInterfaceServer,  Class PolyShape, Class Mesh,  Class Point3,  
Class Point2, Class Matrix3, Class HitRegion, Class GraphicsWindow, Class ViewExp, Class INode, 
Enum MarkerType,
~{ Hit Testing }~\n\n
\par Description:
...
This flag only applies to mesh gizmo.\n\n
...
<b>static const DWORD kGizmoApplyUIScaling</b>\n\n
If the coordinates are in screen space, the coordinates are 100% dpi scaled values
and will be internally converted to current dpi scaling. Note: This is only supported for
PolyShape, Marker and Text gizmos.*/
...
public:
    ...
    */
    ...
    ManipExport Box3 GetBoundingBox(INode* pNode, ViewExp* pVpt);
	 ...
	 /*! \remarks Sets size of the gizmo in pixels for kGizmoScaleToViewport gizmos.
	 \par Parameters:
	 <b>int gizmoSize</b>\n\n
    ...
    ManipExport static const DWORD kGizmoActiveViewportOnly;
	 ...
	 // If dealing with coordinates in screen space, coordinates are 100% dpi scaled 
	 // values and should internally converted to current dpi scaling.
	 ManipExport static const DWORD kGizmoApplyUIScaling;

	 // The default mGizmoSize in pixels. This value is internally dpi scaled when used.
	 ManipExport static const int kDefaultGizmoSize;
...
/*! \sa  Class FPMixinInterface,  Class SimpleManipulator, Class Interface, Class PolyShape, Class Mesh,  
Class Point3,  Class Point2, Class ViewExp, Class IColorManager, Class Ray, Class ManipHitData, 
Enum MarkerType \n\n
\par Description:
...
public:
    ...
    Instruct the gizmo not to do any hit testing. It will still display.\n\n
	 <b>kGizmoActiveViewportOnly</b>\n\n
	 Only display the gizmo in the active viewport.\n\n
	 <b>kGizmoUseRelativeScreenSpace</b>\n\n
	 The coordinates are in normalized screen space. the X and Y values are in the
	 range 0.0 to 1.0, and interpreted as percentages of screen space.\n\n
	 <b>kGizmoUseScreenSpace</b>\n\n
	 The coordinates are in screen space.\n\n
	 <b>kGizmoApplyUIScaling</b>\n\n
	 If the coordinates are in screen space, the coordinates are 100% dpi scaled values
	 and will be internally converted to current dpi scaling.\n\n
...
/*! \sa  Class Manipulator, Class ISimpleManipulator, Class PolyShape, Class GizmoShape, Class ReferenceTarget, 
Class IParamBlock2, Class INode, Class Mesh,  Class Point3, Class Point2, Class ViewExp, Class IColorManager, 
Class Ray, Class ManipHitData, Enum MarkerType\n\n
\par Description:
...
public:
    ManipExport RefResult NotifyRefChanged(const Interval& changeInt,RefTargetHandle hTarget,
    ...
    */
    ...
    ManipExport BOOL ActiveViewOnly() { return mActiveViewOnly; }
	 ...
	 /*! \remarks This method returns the number of gizmos defined.
	 */
	 ManipExport int GetNumberGizmos();

	 /*! \remarks This method returns the specified gizmo.
	 */
...
public:
	...
	/*! \remarks Constructor.
	\param pManip A pointer to the manipulator to use. */
	...
	/*! \brief This method allows you to copy the hit data.
		By default returns:
		\code
