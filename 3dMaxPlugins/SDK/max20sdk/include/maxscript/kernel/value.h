...
#	define	is_bool(v) ((DbgVerify(!is_sourcepositionwrapper(v)), (v))->tag == &Boolean_class)
	Value*	op_not_vf(Value**arg_list, int count);
	Value*	copy_vf(Value** arg_list, int count) { return this; }
	BOOL		to_bool() { return this == &true_value; }
	int		to_int() { return (this == &true_value); }
	INT64		to_int64() { return (this == &true_value); }
	INT_PTR	to_intptr() { return (this == &true_value); }
	...
	BOOL	special_case_compare(Value* arg, bool &specialCaseCompareResult);
