...
/* useful interned names */
	...
	def_name(class)
	def_name(clear)
	def_name(gradientBottom)
	def_name(gradientMiddle)
	def_name(gradientTop)
	def_name(classID)
	def_name(clone)
	def_name(close)
	def_name(cmdPanel)
	...
	def_name(invert)
	def_name(invisible)
	def_name(invisibleInTV)
	def_name(useNodeOsValidity)
	def_name(useNodeTmValidity)
	def_name(enumAsAsset)
	def_name(readOnlyAsset)
	def_name(isAnimated)
	def_name(isChecked)
	def_name(isEmpty)
	def_name(isEnabled)
...
// LAM: Added these 7/23/02
	...
	def_name ( overlay )
	def_name ( duplicateMatchingLayers )
	...
	def_name ( macroRecorderEmitterEnabled )
	def_name ( activeShade )

	def_name ( inputGamma )
	def_name ( inputGammaValue )
	def_name ( metaData )

	def_name ( recurse )

	// For GetActiveShadeBitmap options
	def_name ( wait );           // "wait" mode
	def_name ( timeout );        // Timeout value
	def_name ( result );         // Result (by reference value)
	def_name ( waitTimedOut );   // Return value - We timed out
	def_name ( done );           // Return value - completed normally

	def_name( isIndeterminate );

	// ca def version handling behavior for scene file load and merge
	def_name( neverUpdate );
	def_name( alwaysUpdate );
	def_name( updateWhenLoadVersionGreaterThanCurrentVersion );
	def_name( updateWhenLoadVersionGreaterThanOrEqualToCurrentVersion );

	def_name( simpleMeshMod );
	def_name( modifyMesh );

	def_name ( floatController )
	def_name ( point3Controller )
	def_name ( point4Controller )
	def_name ( colorController )
	def_name ( positionController )
	def_name ( rotationController )
	def_name ( scaleController )
	def_name ( transformController )

	def_name ( setValue )
	def_name ( getValue )
	def_name ( relative )
	def_name ( absolute )
	def_name ( commitValue )
	def_name ( restoreValue )
	def_name ( mouseCycleStarted )
	def_name ( mouseCycleCompleted )
	def_name ( holdBegin )
	def_name ( holdEnd )
	def_name ( holdRestore )
	def_name ( holdRedo )
	def_name ( nodeTransformed )

	def_name ( beziershape )
	def_name ( emptyshape )
	def_name ( excludeOwner )
	def_name ( removeUIScaling )
	def_name ( applyUIScaling )

	def_name ( skipFirstNStackLevels )
	def_name ( monitorID )
	def_name ( iconSize )

	def_name ( mergedNodes )

	def_name ( MXSCallstackCaptureEnabled )

	def_name ( putOnlyIfNew )
	def_name ( string )
	...
	def_name ( useEnumAccessor )
	def_name ( skipSubFiles )
	def_name ( visitOnce )

	def_name ( errormessage)
	def_name ( bufferedWrite )

	def_name ( preSet )
	def_name ( postSet )

	def_name ( isMXSPluginClass )
	def_name ( PB2SpecialCases )

	def_name ( useULong )
	def_name ( setLocation )

	def_name ( basic )
	def_name ( full )
	def_name ( sendDump )

	def_name ( ignoreCache )
	def_name ( exitCode )

	def_name ( autoLayoutOnResize )
	def_name ( forceUpdate )
	def_name ( rolloutFloater )
