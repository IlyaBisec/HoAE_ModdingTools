...
protected:
    ...
    const D3DCAPS9&         GetCaps() const { return m_d3dSettings.PDeviceInfo()->m_Caps; }
    int                     GetBackBufferW() const { return m_d3dsdBackBuffer.Width; }
    int                     GetBackBufferH() const { return m_d3dsdBackBuffer.Height; }
...
protected:
    ...
    LPDIRECT3DDEVICE9       m_pDevice;              // The D3D rendering device
    D3DCAPS9                m_Caps;                 // Caps for the device
    ...
    DEVMODE                 m_InitialDesktopMode;

    WNDPROC                 m_HostWndProc;          // Host window window procedure
...
public:
    ...
    virtual HRESULT         Create          ( HINSTANCE hInstance, HWND hWnd );
    virtual LRESULT         MsgProc         ( HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam );

    LRESULT                 HostWndProc     ( HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam );	
