...
/*    Date:    08-20-2003
/*****************************************************************************/
#ifndef __UIFONTMANAGER_H__
#define __UIFONTMANAGER_H__
...
/*    Desc:    Implementation of the ui manager
/*****************************************************************************/    
class FontManager : public SNode, public IFontManager, public IDeviceClient
{
public:
                    FontManager        ();
                    ~FontManager        ();
    ...
    DECLARE_SCLASS(FontManager, SNode, WIDM);
